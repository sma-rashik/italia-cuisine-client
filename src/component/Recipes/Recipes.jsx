...
//                 <span className=" font-bold text-yellow-500 dark:text-white">
//                   <Rating
...
//                     fullSymbol={<FaStar />}
//                   />
//                   <span className="text-black p-3">{chef.rating}</span>
//                 </span>
...
//                 }}
//                 >
//                   {recipe.isFavorite ? "Added to Favorites" : "Add to Favorites"}
//                 </button>
//               </div>
//             ))}
//           </div>
